...
from cube2common.stream_specification import StreamSpecification, MessageType,\
    Field, TerminatedFieldCollection, FieldCollection, IteratedFieldCollection,\
    ConditionalFieldCollection, RawField, StreamContainerType
...
sc = StreamContainerType(CubeDataStream, type_method_mapping, {}, "int", FieldCollection(Field(name="clientnum", type="int")), Field(type="uint"), message_types)
